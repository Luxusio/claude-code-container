...
export const HYPER_V_PROVIDER_IMAGE_FINALIZATION_CONTRACT = "hyper-v-provider-image-finalization-v39";
...
export type HyperVSnapshotRepairObservation = {
    ok: true;
    checkpointPolicy: "Production" | "ProductionOnly";
    candidateCount: 0 | 1;
};
...
export type HyperVCreateOptions = HyperVCommandOptions & {
    ...
    checkpointType?: "Production" | "ProductionOnly";
