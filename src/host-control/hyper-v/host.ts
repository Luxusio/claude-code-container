...
function hyperVEnsureNetworkScript(options: HyperVNetworkOptions): string {
    ...
    return jsonScript([
        ...
        "$env:CCC_HYPER_V_STAGE = 'hyper-v-network-switch-inspection-failed'",
        ...
        "    $env:CCC_HYPER_V_STAGE = 'hyper-v-network-identity-repair-failed'",
        ...
        "      $ExpectedStable = $Marker -ceq 'ccc-device-lab:hyper-v-network:v1' -and $NatName -ceq 'CCCDeviceLab'",
        "      $ObservedStable = $ObservedMarker -ceq 'ccc-device-lab:hyper-v-network:v1'",
        "      $TokenToStable = $ExpectedTokenMatch.Success -and $NatName -ceq ('CCCDeviceLab-' + $ExpectedTokenMatch.Groups[1].Value) -and $ObservedStable",
        "      $StableToToken = $ExpectedStable -and $TokenMatch.Success",
        ...
        "      if ($ObservedStable) { $NatName = 'CCCDeviceLab' } else { $NatName = 'CCCDeviceLab-' + $TokenMatch.Groups[1].Value }",
        ...
        "}",
        "$env:CCC_HYPER_V_STAGE = 'hyper-v-network-adapter-inspection-failed'",
        ...
        "$env:CCC_HYPER_V_STAGE = 'hyper-v-network-subnet-inspection-failed'",
        ...
        "$env:CCC_HYPER_V_STAGE = 'hyper-v-network-nat-inspection-failed'",
        ...
        "$env:CCC_HYPER_V_STAGE = 'hyper-v-network-gateway-inspection-failed'",
        ...
        "try {",
        "  $env:CCC_HYPER_V_STAGE = 'hyper-v-network-switch-create-failed'",
        ...
        "    $env:CCC_HYPER_V_STAGE = 'hyper-v-network-gateway-create-failed'",
        ...
        "  }",
        "  $env:CCC_HYPER_V_STAGE = 'hyper-v-network-nat-create-failed'",
