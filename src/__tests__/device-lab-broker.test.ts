...
describe("device-lab host broker daemon", () => {
    ...
    it.each([
        ...
        ["redacted Hyper-V network stage diagnostics", "hyper-v-network-failure-diagnostics-v8", "hyper-v-network-failure-diagnostics-v7"],
        ["persisted Hyper-V network identity repair", "hyper-v-setup-network-v8", "hyper-v-setup-network-v7"],
