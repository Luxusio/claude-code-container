...
describe("device-lab host broker daemon", () => {
    ...
    it("replaces a same-version broker whose only stale contract is Hyper-V lifecycle v15", async () => {
        ...
        const staleHyperVCapabilities = [
            ...currentCapabilities.filter((capability) => capability !== "hyper-v-vm-managed-auto-images-v16"),
            "hyper-v-vm-managed-auto-images-v15",
        ];
        ...
        try {
            ...
            expect(incompatibleStatus).toEqual(expect.objectContaining({
                missingCapabilities: ["hyper-v-vm-managed-auto-images-v16"],
            }));
        } finally {
            killSpy.mockRestore();
