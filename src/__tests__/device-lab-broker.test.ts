...
describe("device-lab host broker daemon", () => {
    ...
    it("builds zero-config status metadata without side effects", () => {
        ...
        expect(status).toEqual(expect.objectContaining({
            ...
            implemented: expect.arrayContaining([
                ...
                "hyper-v-windows-unattend-oobe-schema-v1",
                "hyper-v-powershell-direct-bounded-probe-v1",
                "hyper-v-windows-library-v1",
    ...
    it.each([
        ...
        ["Windows unattend oobe schema", "hyper-v-windows-unattend-oobe-schema-v1", null],
        ["bounded PowerShell Direct probe", "hyper-v-powershell-direct-bounded-probe-v1", null],
        ["internal Hyper-V Windows library", "hyper-v-windows-library-v1", null],
