...
describe("device-lab host broker daemon", () => {
    ...
    it.each([
        ...
        ["persisted Hyper-V network marker migration", "hyper-v-setup-network-v7", "hyper-v-setup-network-v6"],
