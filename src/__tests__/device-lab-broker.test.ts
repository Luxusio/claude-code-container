...
describe("device-lab host broker daemon", () => {
    ...
    it.each([
        ...
        ["redacted Hyper-V network stage diagnostics", "hyper-v-network-failure-diagnostics-v4", "hyper-v-network-failure-diagnostics-v3"],
