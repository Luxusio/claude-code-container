...
describe("device-lab host broker daemon", () => {
    ...
    it.each([
        ...
        ["provider-bound automatic image finalization", "hyper-v-provider-image-finalization-v3", null],
        ["redacted Hyper-V network stage diagnostics", "hyper-v-network-failure-diagnostics-v9", "hyper-v-network-failure-diagnostics-v7"],
        ["persisted Hyper-V network identity repair", "hyper-v-setup-network-v9", "hyper-v-setup-network-v7"],
