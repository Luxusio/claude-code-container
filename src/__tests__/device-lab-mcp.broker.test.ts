...
describe("device-lab MCP", () => {
    ...
    it.each([
        ...
        ["Hyper-V provider-bound automatic image finalization contract", "hyper-v-provider-image-finalization-v24"],
