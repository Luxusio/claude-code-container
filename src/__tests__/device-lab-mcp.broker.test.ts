...
describe("device-lab MCP", () => {
        ...
        const server = createServer((req, res) => {
            ...
            if (req.url === "/status") {
                res.end(JSON.stringify({
                    ...
                    broker: {
                        implemented: [
                            ...REQUIRED_CCC_HOST_BROKER_CAPABILITIES.filter((capability) => capability !== "hyper-v-setup-network-v8"),
        ...
        try {
            ...
            expect(result).toEqual(expect.objectContaining({
                ...
                launch: expect.objectContaining({
                    ...
                    error: "host-broker-incompatible",
                    compatibility: expect.objectContaining({
                        missingCapabilities: ["hyper-v-setup-network-v8"],
                    }),
                }),
            }));
        } finally {
    ...
    it.each([
        ...
        ["Hyper-V redacted network failure diagnostics", "hyper-v-network-failure-diagnostics-v2"],
