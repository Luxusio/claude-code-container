...
describe("device-lab MCP", () => {
    ...
    it.each([
        ["Azure-compatible Hyper-V guest seeding v1", "hyper-v-azure-ovf-seed-v1"],
        ["Azure-compatible Hyper-V guest seeding v2", "hyper-v-azure-ovf-seed-v2"],
        ["Azure Hyper-V bootstrap DHCP networking", "hyper-v-azure-bootstrap-dhcp-v1"],
        ["local Hyper-V Azure OVF behavior", "hyper-v-azure-local-ovf-v1"],
        ...
        ["Hyper-V provider-bound automatic image finalization contract", "hyper-v-provider-image-finalization-v27"],
