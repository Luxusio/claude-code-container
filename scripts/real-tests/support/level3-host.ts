...
export const HYPER_V_LEVEL3_REQUIRED_BROKER_CAPABILITIES = [
    ...
    "hyper-v-provider-image-finalization-v35",
    "hyper-v-network-failure-diagnostics-v9",
];
export const HYPER_V_LEVEL3_PROVIDER_CONTRACT = "hyper-v-provider-image-finalization-v35";
...
export const HYPER_V_LEVEL3_GUEST_DIAGNOSTICS_CONTRACT = "hyper-v-guest-readiness-diagnostics-v16";
