...
export const HYPER_V_LEVEL3_REQUIRED_BROKER_CAPABILITIES = [
    ...
    "hyper-v-network-failure-diagnostics-v2",
];
...
export const HYPER_V_LEVEL3_NETWORK_DIAGNOSTICS_CONTRACT = "hyper-v-network-failure-diagnostics-v2";
