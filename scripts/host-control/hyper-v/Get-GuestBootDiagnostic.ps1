...
Import-Module (Join-Path $PSScriptRoot 'Ccc.HyperV.Diagnostics.psm1') -Force -ErrorAction Stop

$Contract = Read-CccJsonContract
$Vm = Get-CccOwnedVm $Contract
Get-CccGuestBootDiagnosticResult $Vm | ConvertTo-Json -Compress -Depth 5
