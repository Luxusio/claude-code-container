...
export interface DeviceLabToolOutputMap {
    ...
    device_base_image_create: LifecycleOutput; device_base_image_clone: LifecycleOutput; device_snapshot_list: ObjectOutput; device_snapshot_create: ObjectOutput; device_snapshot_restore: LifecycleOutput; device_snapshot_delete: DeleteOutput;
