...
export function claimIosRealDevice(device) {
    return claimOwnerDevice(BACKEND, device, ["id", "udid"]);
}
...
export function transitionIosRealDevice(id, expected, replacement) {
